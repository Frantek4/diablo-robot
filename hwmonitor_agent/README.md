...
ViewPower) y de red (latencia, jitter, pérdida de paquetes, DNS, tráfico y
velocidad de bajada) en `GET /metrics`, para que Diablo Robot lo consulte por
la VPN de WireGuard y mantenga el banner de estado en el canal de admin
(`#robot-devil`).
