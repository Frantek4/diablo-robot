...
class InstagramCommand(commands.Cog):
    ...
    async def instagram(self, ctx, accion: str = ""):
        """Muestra cómo viene el scaneo de Instagram; con 'reanudar' lo despierta si quedó frenado"""
    ...
    async def _reanudar(self, ctx):
        ...
        await ctx.send("Listo, vuelvo a leer Instagram. Ojalá hayas rehecho la sesión.")
