...
- `GOOGLE_CALENDAR_ID`, `GOOGLE_SERVICE_ACCOUNT_FILE` — calendario donde se espejan los partidos y ruta al JSON de la service account que lo escribe (ambos opcionales; si falta alguno el espejo no corre). Ver `docs/GOOGLE-CALENDAR.md`
