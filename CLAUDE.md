...
- `NITTER_HOST_URL` — URL de la instancia propia de Nitter (ej. `http://127.0.0.1:19050`). Si falta, el scaneo de Twitter no corre. Ver `nitter/README.md` para levantarla
